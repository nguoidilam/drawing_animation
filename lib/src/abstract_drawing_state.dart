...
abstract class AbstractAnimatedDrawingState extends State<AnimatedDrawing> {
  ...
  List<PathSegment>? pathSegmentsToAnimate; //defined by [range.start] and [range.end]
  List<PathSegment>? pathSegmentsToPaintAsBackground; //defined by < [range.start]
  ...
  PathPainter? buildForegroundPainter() {
    ...
    PathPainterBuilder builder =
        preparePathPainterBuilder(lineAnimation: this.widget.lineAnimation!);
  ...
  PathPainterBuilder preparePathPainterBuilder({LineAnimation? lineAnimation}) {
    PathPainterBuilder builder = PathPainterBuilder(lineAnimation: lineAnimation);
